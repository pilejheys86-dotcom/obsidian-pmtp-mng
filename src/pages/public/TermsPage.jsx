...
const SectionHeading = ({ id, number, title }) => (
  <h2 id={id} className="text-xl md:text-2xl font-display font-light mb-4 scroll-mt-24">
  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto px-6 pb-24 flex gap-0 lg:gap-12 relative">
        ...
        <aside aria-label="Section navigation" className="hidden lg:block w-56 flex-shrink-0">
      ...
      <div className="lg:hidden">
        ...
        >
          <aside
            ...
            className={`absolute inset-y-0 left-0 w-72 max-w-[80vw] bg-white dark:bg-neutral-900 shadow-2xl overflow-y-auto transition-transform duration-300 ease-in-out ${drawerOpen ? 'translate-x-0' : '-translate-x-full'}`}
