                ...
                <div className="bg-neutral-950 rounded-[2rem] overflow-hidden">
                  ...
                  <div className="px-5 pb-3">
                    <div className="bg-white/10 rounded-xl p-4 border border-white/5">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <span className="text-[9px] font-bold bg-emerald-500/20 text-emerald-400 px-2 py-0.5 rounded-full">Active</span>
                      </div>
                  ...
                  <div className="px-5 pb-3">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <div className="bg-white/10 rounded-lg p-3 flex flex-col items-center gap-1.5 border border-white/5">
                      ...
                      <div className="bg-white rounded-lg p-3 flex flex-col items-center gap-1.5">
          ...
          <div className="order-1 lg:order-2 space-y-8">
            <div ref={headingRef} className="space-y-6 reveal-fade-up">
              ...
              <h2 className="landing-h2 font-display font-light">
                Your pawnshop, <br />
                <span className="underline decoration-2 underline-offset-4 decoration-neutral-300 dark:decoration-neutral-600">right in your pocket.</span>
              </h2>
